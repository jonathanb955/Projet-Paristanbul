...
<section class="rayons-section">
    <div class="container">
        ...
        <div class="btn-add-rayon">
            <a href="#" class="btn-green">Découvrir nos rayons</a>
        </div>
        <div class="rayons-grid">
            <div class="rayon-card">
                <div class="icon"><img src="icon-legume.png" alt="Fruits et Légumes" /></div>
                <h3>Fruits et Légumes</h3>
                <p>Des produits frais et de saison, souvent issus de producteurs locaux.</p>
                <a href="#" class="discover" style="color: #003366">Découvrir →</a>
            </div>
            <div class="rayon-card">
                <div class="icon"><img src="icon-viande.png" alt="Boucherie" /></div>
                <h3>Boucherie & Poissonnerie</h3>
                <p>Viandes et poissons frais sélectionnés avec soin par nos experts.</p>
                <a href="#" class="discover">Découvrir →</a>
            </div>
            <div class="rayon-card">
                <div class="icon"><img src="icon-gateau.png" alt="Boulangerie" /></div>
                <h3>Boulangerie & Pâtisserie</h3>
                <p>Pains frais, viennoiseries et pâtisseries préparés sur place chaque jour.</p>
                <a href="#" class="discover">Découvrir →</a>
            </div>
        </div>
    </div>
