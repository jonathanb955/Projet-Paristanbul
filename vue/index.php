    ...
    <!-- 1) Redirection boutique app (avec garde si l’ID n’existe pas) -->
    <script>
        document.addEventListener("DOMContentLoaded", function () {
            const link = document.getElementById('app-store-link');
            if (!link) return; // évite une erreur JS si l'élément n'existe pas
            link.addEventListener('click', function(e) {
                e.preventDefault();
                const userAgent = navigator.userAgent || navigator.vendor || window.opera;
                if (/android/i.test(userAgent)) {
                    window.location.href = "https://play.google.com/store/apps/details?id=com.tonapp.nom";
                } else if (/iPad|iPhone|iPod/.test(userAgent) && !window.MSStream) {
                    window.location.href = "https://apps.apple.com/fr/app/ton-app/idXXXXXXXXX";
                } else {
                    window.location.href = "https://paristanbul.fr/telecharger";
                }
            });
        });
    </script>

    <!-- 2) Animations : reveal / ripple / tilt / bouton top + NAV TOUJOURS VISIBLE -->
    <script>
        document.addEventListener('DOMContentLoaded', () => {
            ...
            window.addEventListener('scroll', () => {
                ...
                nav.classList.remove('nav--hide'); // on force la nav visible
                lastY = y;
            }, {passive:true});

            /* -------- Ripple click sur boutons -------- */
    ...
    <!-- 3) Loader / Parallax / Shimmer / Compteurs + NAV TOUJOURS VISIBLE -->
    <script>
        document.addEventListener('DOMContentLoaded', () => {
            const prefersReduced = window.matchMedia('(prefers-reduced-motion: reduce)').matches;
        ...
        <div class="loader__wrap">
          ...
          <img class="loader__logo" src="../assets/img/paristanbul_logo_1200x350-1024x299.png" alt="Paristanbul">
            ...
            if (!prefersReduced && 'IntersectionObserver' in window) {
                ...
                const els = sel.flatMap(s => Array.from(document.querySelectorAll(s)));
            ...
            /* ---------- Shimmer placeholders sur images produits ---------- */
            ...
            /* ---------- Compteurs animés + flip sur prix ---------- */
            ...
            /* ---------- Bouton “haut de page” (si pas déjà injecté) ---------- */
